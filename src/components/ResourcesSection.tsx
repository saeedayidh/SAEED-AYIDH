    ...
    <section id="resources-section" className="py-24 relative bg-[#0D0D0D] border-t border-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight">أدوات سعيد</h2>
          <p className="text-base sm:text-lg text-[#B8B8B8] font-light leading-relaxed">
            هذا القسم مخصص لأدوات سعيد الأصلية. تمت إزالة النماذج التجريبية وسيتم عرض الأدوات المعتمدة هنا فقط.
          </p>
