...
export type PlatformButton = { label:string; url:string; enabled:boolean };
export type PlatformItem = { id:string; title:string; description:string; badge:string; imageUrl:string; videoUrl:string; enabled:boolean; order:number; buttons:PlatformButton[] };
